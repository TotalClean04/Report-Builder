# Permit AI Reading — Setup Guide

The app reads permit pages with AI. For security, the AI call goes through a
small helper program called a **proxy** that holds your Anthropic API key.
This guide sets it up. It takes about 10 minutes, once.

Everything else in the app (adding permit pages, inserting them into Appendix B,
and typing/editing the permit list by hand) works **without** any of this. The
proxy is only needed for the "Read permits with AI" button.
